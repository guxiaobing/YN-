...
//			}
			...
			for(int i=0;i<dateList.size();i++){
				...
				conn.commit();
				System.out.println(bgDate+">>>"+endT+" 未计算监测点："+errList.toString());
				System.out.println(bgDate+">>>"+endT+" 成功更新："+upCount);
				System.out.println(bgDate+">>>"+endT+" 成功插入："+inCount);
				pst.close();
				errList.clear();
			}
